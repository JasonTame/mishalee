...
function bbs_global_enqueues() {
    ...
    // javascript
    //Removed fix.js as it created wrapper issues when mixed with portfolio plugin
...
function bbs_hidetitle_class($classes) {
...
add_filter('post_class', 'bbs_hidetitle_class');
